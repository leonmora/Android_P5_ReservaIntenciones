...
public class MainActivity extends Activity implements OnSeekBarChangeListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			if (datosRecibidos.getString("FormaPago") != null)
				Toast.makeText(getApplicationContext(), "Reserva hecha. Forma de Pago: " + datosRecibidos.getString("FormaPago"), Toast.LENGTH_SHORT).show();
